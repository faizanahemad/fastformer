...
if __name__ == "__main__":
    ...
    lm_cmd += " --total_steps 1000000 --lr 0.004 --batch_size 16 --lr_steps 1 --weight_decay 0.005"
    ...
    mlm_cmd += " --total_steps 1000000 --batch_size 2 --lr 0.0002 --weight_decay 0.01 --gradient_clipping 1.0 --accumulation_steps 8"
    mlm_cmd += " --model_save_dir /home/ahemf/model_save_dir --model_save_name roberta-large-hard-1M.pth --wandb_name hard-mlm-1M-2048"
    mlm_cmd += " --master_addr 0.0.0.0 --master_port 9999 --dataset /home/ahemf/processed_datasets/c4_sbert_perplexity_tfidf --log_every_steps 10 --num_workers 8"
    mlm_cmd += " --hard_mlm --hard_mlm_model /home/ahemf/model_save_dir/cooc_7_roberta.pth --sampling_column sbert-perplexity-tfidf"
    mlm_cmd += " --pretrained_model /home/ahemf/model_save_dir/roberta-large-hard-1M.pth"
    mlm_cmd += " > output.log 2>&1 & disown"

    # mlm_cmd = "python train_mlm_sop.py --model_config roberta-large -n %s --nr %s"
    # mlm_cmd += " --total_steps 100000 --batch_size 2 --lr 0.0002 --weight_decay 0.005 --gradient_clipping 1.0 --accumulation_steps 32"
    # mlm_cmd += " --model_save_dir /home/ahemf/model_save_dir --model_save_name roberta-large-continual.pth --wandb_name continual-2048"
    # mlm_cmd += " --master_addr 0.0.0.0 --master_port 9999 --dataset /home/ahemf/processed_datasets/c4_sbert_perplexity_tfidf --log_every_steps 10 --num_workers 8"
    # mlm_cmd += " --hard_mlm --hard_mlm_model /home/ahemf/model_save_dir/cooc_7_roberta.pth --sampling_column sbert-perplexity-tfidf"
    # mlm_cmd += " --pretrained_model roberta-large"
    # mlm_cmd += " --pretrained_model /home/ahemf/model_save_dir/roberta-large-continual.pth"
    # mlm_cmd += " > output.log 2>&1 & disown"
