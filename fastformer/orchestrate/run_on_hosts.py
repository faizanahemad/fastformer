...
if __name__ == "__main__":
    ...
    vision_cmd += " --wandb_name gen_disc_0_2_2_0_s1"
    ...
    vision_cmd += " --mode clr"
    vision_cmd += " --lr 0.004 --lr_steps 2 --weight_decay 0.05 --warmup_steps 1000 --gradient_clipping 5.0 --simclr_warmup 1000 --teacher_warmup_steps 1000"
    vision_cmd += " --batch_size 16 --optimizer adamw"

    vision_cmd += " --simclr_w 0.0 --generator_w 2.0 --discriminator_w 2.0 --dino_w 0.0"
