...
if __name__ == "__main__":
    ...
    lm_cmd += " --cls_tokens 2"
    lm_cmd += " --wandb_name approx_dino_@3_6@_1_1_50_1_s2"
    ...
    lm_cmd += " --epochs 1 --lr 0.00005 --batch_size 4 --lr_steps 1 --weight_decay 0.01"
    ...
    lm_cmd += " --no_autocast"
    lm_cmd += " --lm_layers 3 --electra_layers 6 --lm_layers_total 8 --electra_layers_total 24"
