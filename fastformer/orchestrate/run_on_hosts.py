...
if __name__ == "__main__":
    ...
    vision_cmd += " --wandb_name all_05_1_1_05_s2"
    ...
    vision_cmd += " --mode clr"
    vision_cmd += " --lr 0.002 --lr_steps 2 --weight_decay 0.05 --warmup_steps 1000 --gradient_clipping 1.0 --simclr_warmup 1000 --teacher_warmup_steps 1000"
    vision_cmd += " --batch_size 16 --optimizer rangerlars"

    vision_cmd += " --simclr_w 0.5 --generator_w 1.0 --discriminator_w 1.0 --dino_w 0.5"
