...
if __name__ == "__main__":
    ...
    lm_cmd += " --cls_tokens 2"
    lm_cmd += " --wandb_name all_1_1_50_1_32"
    ...
    lm_cmd += " --epochs 1 --lr 0.0001 --batch_size 4 --lr_steps 2"
    lm_cmd += " --warmup_steps 20000 --gradient_clipping 3.0 --teacher_warmup_steps 5000"
