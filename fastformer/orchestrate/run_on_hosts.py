...
if __name__ == "__main__":
    ...
    lm_cmd += " --cls_tokens 2"
    lm_cmd += " --wandb_name all_1_1_50_2_md"
    ...
    lm_cmd += " --epochs 1 --lr 0.0002 --batch_size 4 --lr_steps 2"
    lm_cmd += " --warmup_steps 10000 --gradient_clipping 3.0 --teacher_warmup_steps 1000"
    lm_cmd += " --sentence_order_prediction_w 1.0 --generator_w 1.0 --discriminator_w 50.0 --dino_w 2.0"  # --attention_penalty_w 100.0
