...
if __name__ == "__main__":
    ...
    vision_cmd += " --log_every_steps 100 --num_workers 8 --save_every_steps 1000 --init_method=tcp  --master_addr 0.0.0.0 --master_port 9999 --mode linear_probe --shuffle_dataset --accumulation_steps 4 --epochs 100"
