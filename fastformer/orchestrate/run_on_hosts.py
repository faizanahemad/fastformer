...
if __name__ == "__main__":
    ...
    lm_cmd += " --cls_tokens 2"
    lm_cmd += " --wandb_name tricks_consec_α0_sf075_@4_24_12@_1_1_50_0_m1"  #
    ...
    lm_cmd += " --warmup_steps 50000 --gradient_clipping 3.0 --teacher_warmup_steps 1000"
    ...
    lm_cmd += " --no_autocast"
    lm_cmd += " --lm_layers 4 --electra_layers 12 --lm_layers_total 24 --electra_layers_total 24"
    # lm_cmd += " --drop_unused_layers"
    lm_cmd += " --consecutive_layers"
    lm_cmd += " --sampling_alpha 0.0"
    lm_cmd += " --start_from_proba 0.75"
