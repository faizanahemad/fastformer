...
if __name__ == "__main__":
    ...
    lm_cmd += " --cls_tokens 2"
    lm_cmd += " --wandb_name L_sd_approx_3_6_dino_hway_1_1_50_1_m1"
    lm_cmd += " --dataset /home/ahemf/processed_datasets/all512"
    lm_cmd += " --log_every_steps 50 --num_workers 1 --save_every_steps 1000"
    # lm_cmd += " --wandb_dryrun"
    lm_cmd += " --init_method=tcp  --master_addr 0.0.0.0 --master_port 9998 --shuffle_dataset --accumulation_steps 4"
    lm_cmd += " --epochs 1 --lr 0.0001 --batch_size 4 --lr_steps 1 --weight_decay 0.05"
    lm_cmd += " --warmup_steps 10000 --gradient_clipping 3.0 --teacher_warmup_steps 10000"
    ...
    lm_cmd += " --no_autocast"
    lm_cmd += " --lm_layers 3 --electra_layers 6 --lm_layers_total 12 --electra_layers_total 24 --approximate_unused_layers"
