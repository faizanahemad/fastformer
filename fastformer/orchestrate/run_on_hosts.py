...
if __name__ == "__main__":
    ...
    vision_cmd += " --wandb_name gen_disc_0_1_1_0_s1"
    ...
    vision_cmd += " --mode clr"
    vision_cmd += " --lr 0.002 --lr_steps 1 --weight_decay 0.05 --warmup_steps 10000 --gradient_clipping 3.0 --simclr_warmup 1000 --teacher_warmup_steps 1000"
    vision_cmd += " --batch_size 4 --optimizer adamw"
