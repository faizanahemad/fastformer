...
if __name__ == "__main__":
    ...
    lm_cmd += " --cls_tokens 2"
    lm_cmd += " --wandb_name approx_α075_@3_9@_1_1_50_0_h32"  #
    ...
    lm_cmd += " --epochs 1 --lr 0.0001 --batch_size 4 --lr_steps 1 --weight_decay 0.005"
    ...
    lm_cmd += " --sampling_alpha 0.75"
    # lm_cmd += " --exclude_layers"
    lm_cmd += " --beta_1 0.7 --beta_2 0.75"
