...
if __name__ == "__main__":
    ...
    mlm_cmd += " --total_steps 1000000 --batch_size 2 --lr 0.0003 --weight_decay 0.005 --gradient_clipping 3.0 --accumulation_steps 8"
    ...
    # mlm_cmd = "python train_mlm_sop.py --model_config roberta-large -n %s --nr %s"
    # mlm_cmd += " --total_steps 100000 --batch_size 2 --lr 0.00005 --weight_decay 0.0001 --gradient_clipping 1.0 --accumulation_steps 16"
