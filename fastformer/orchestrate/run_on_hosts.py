...
if __name__ == "__main__":
    ...
    vision_cmd = "python train_vision_distributed.py -n %s -g 8 --nr %s --model_config vision_base_rel_config"
    ...
    vision_cmd += " --log_every_steps 100 --num_workers 8 --save_every_steps 1000 --init_method=tcp  --master_addr 0.0.0.0 --master_port 9999 --mode linear_probe --shuffle_dataset --accumulation_steps 4 --epochs 300"
    vision_cmd += " --no_autocast"
    vision_cmd += " --lr 0.0001"
    vision_cmd += " --batch_size 32"
    vision_cmd += " --moco"
    # vision_cmd += " --simclr_moco"
    vision_cmd += " --simclr_w 1.0 --patchclr_w 0.0"
