...
if __name__ == "__main__":
    ...
    vision_cmd += " --log_every_steps 100 --num_workers 8 --save_every_steps 1000 --init_method=tcp  --master_addr 0.0.0.0 --master_port 9999 --shuffle_dataset --accumulation_steps 2 --epochs 300"
    vision_cmd += " --mode clr"
    vision_cmd += " --no_autocast"
    vision_cmd += " --lr 0.0002"
    vision_cmd += " --batch_size 4"
    vision_cmd += " --moco"
    vision_cmd += " --total_samples_simclr 131072"
