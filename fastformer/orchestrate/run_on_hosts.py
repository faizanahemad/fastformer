...
if __name__ == "__main__":
    ...
    lm_cmd += " --model_config prenorm-roberta-xlarge"
    lm_cmd += " --cls_tokens 1"
    lm_cmd += " --wandb_name consec_nk_α0_sf1_40kW_@4_48_12@_1_1_50_0_h32"  #
    ...
    lm_cmd += " --epochs 2 --lr 0.001 --batch_size 2 --lr_steps 1 --weight_decay 0.005"
