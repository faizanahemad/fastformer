...
if __name__ == "__main__":
    ...
    lm_cmd += " --cls_tokens 2"
    lm_cmd += " --wandb_name tricks_consec_α05_@4_12@_1_1_50_0_m2"  #
    ...
    lm_cmd += " --no_autocast"
    lm_cmd += " --lm_layers 4 --electra_layers 12 --lm_layers_total 8 --electra_layers_total 24"
    # lm_cmd += " --drop_unused_layers"
    lm_cmd += " --consecutive_layers"
    lm_cmd += " --sampling_alpha 0.5"
    lm_cmd += " --start_from_proba 0.5"
