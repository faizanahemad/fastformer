...
if __name__ == "__main__":
    ...
    vision_cmd += " --log_every_steps 100 --num_workers 8 --save_every_steps 1000 --init_method=tcp  --master_addr 0.0.0.0 --master_port 9999 --shuffle_dataset"
    vision_cmd += " --accumulation_steps 1 --epochs 300"
    vision_cmd += " --mode clr"
    ...
    vision_cmd += " --pct_simclr_simple 3"
