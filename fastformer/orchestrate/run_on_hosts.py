...
if __name__ == "__main__":
    ...
    vision_cmd += " --log_every_steps 100 --num_workers 8 --save_every_steps 5000 --init_method=tcp  --master_addr 0.0.0.0 --master_port 9999 --mode clr --shuffle_dataset --accumulation_steps 4 --no_autocast --epochs 300 --lr 0.00002"
