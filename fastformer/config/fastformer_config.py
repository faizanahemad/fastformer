...
model_config: ModelConfig = ModelConfig("bert", "md_config", aitm=False, alum=False,
                                        ...
                                        input_cls_orthogonal_w=0.01,
                                        electra_loss_w=2.0, lm_loss_w=0.5, sentence_order_prediction_w=0.5, contrastive_w=0.0, contrastive_temperature=5e-2,
                                        answering_lm_w=0.25, additive_margin_softmax_w=0.2)
...
vision_base_config = FastFormerConfig(stride=1, d_head=[64, 64], n_head=[(12, 0, 0), (12, 0, 0)], block_channel_size=[768, 768], num_decoder_layers=2, block_sizes=[6, 6], num_highway_cls_tokens=4, has_decoder=False,
                                      hidden_dropout=0.1, attention_dropout=0.1, max_position_embeddings=196, relative_attention=False)
...
vision_lg_rel_config = FastFormerConfig(stride=2, d_head=[64, 64], n_head=[(8, 0, 0), (16, 0, 0)], block_channel_size=[512, 768], num_decoder_layers=2, block_sizes=[6, 6], num_highway_cls_tokens=4, has_decoder=False,
...
vision_config_dict = dict(vision_md_config=vision_md_config, vision_lg_config=vision_lg_config,
                          vision_md_rel_config=vision_md_rel_config, vision_lg_rel_config=vision_lg_rel_config,
