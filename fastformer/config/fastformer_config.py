...
model_config: ModelConfig = ModelConfig("bert", "md_config", aitm=False, alum=False,
                                        ...
                                        electra_loss_w=2.0, lm_loss_w=0.5, sentence_order_prediction_w=0.5, contrastive_w=2.0, contrastive_temperature=5e-2,
                                        answering_lm_w=0.5, additive_margin_softmax_w=0.2)
