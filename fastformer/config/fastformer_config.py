...
optimizer_config = OptimizerConfig(2e-5, 1e-4, 1e-4, 0.9, 0.98,
                                   8, 8, 40000, 0.1)
...
vision_md_rel_config = FastFormerConfig(stride=1, d_head=[48, 64], n_head=[(8, 0, 0), (12, 0, 0)], block_channel_size=[384, 768],
                                        num_decoder_layers=2, block_sizes=[4, 6], num_highway_cls_tokens=2,
                                        max_position_embeddings=14, relative_attention=True)
vision_md_rel_funnel_config = FastFormerConfig(stride=2, d_head=[48, 64], n_head=[(8, 0, 0), (12, 0, 0)], block_channel_size=[384, 768],
                                        num_decoder_layers=2, block_sizes=[4, 6], num_highway_cls_tokens=2,
                                        max_position_embeddings=14, relative_attention=True)
