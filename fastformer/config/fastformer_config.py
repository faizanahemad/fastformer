...
optimizer_config = OptimizerConfig(3e-5, 1e-4, 1e-4, 0.9, 0.98,
                                   8, 8, 40000, 1.0)
...
model_config: ModelConfig = ModelConfig("bert", "md_config", aitm=False, alum=False,
                                        ...
                                        electra_loss_w=0.5, lm_loss_w=0.5, sentence_order_prediction_w=1.0, contrastive_w=0.0, contrastive_temperature=1e-2,
...
dg_config = FastFormerConfig(separate_content_and_position_attention=False, pooling_type="mean", pooling_kernel_size=3, use_cuda_conv=True, embedding_size=256,
