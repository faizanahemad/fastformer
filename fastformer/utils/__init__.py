...
class CoOccurenceModel(PreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask, *args, **kwargs):
        ...
        return dict(loss=masked_lm_loss, masked_lm_loss=masked_lm_loss, transformer_loss=transformer_loss, selected_mask_accuracy=selected_mask_accuracy,
                    ...
                    word_ce=final_ce, prediction_scores=prediction_scores, top_k_alternatives=None, lm_predictions=lm_predictions)
...
class MetricLogger(object):
    ...
    def log_every(self, iterable, print_freq, header=None):
        ...
        iter_time = SmoothedValue(fmt='{avg:.4f}', window_size=100)
        data_time = SmoothedValue(fmt='{avg:.4f}', window_size=100)
